...
// Cron Ekleme
if (!array_search("/usr/local/bin/actspot_check.sh", array_column($config['cron']['item'], "command"))) {
    $config['cron']['item'][] = array(
        ...
        "wday" => "*",
        "who" => "root",
        "command" => "/usr/local/bin/actspot_check.sh"
    );
    write_config("actspot Check Cron added.");
}
...
$freeradiusclients = [
    ...
    'varclientshortname' => "actspot",
    'varclientsharedsecret' => "actspot",
    'varclientproto' => "udp",
...
$config['system']['authserver'][] = array(
	...
	'radius_secret' => 'actspot',
	'radius_timeout' => '5',
	'radius_auth_port' => '1812',
	'radius_acct_port' => '1813',
);

write_config("actspot Settings added.");
